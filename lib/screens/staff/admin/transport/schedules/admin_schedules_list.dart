...
class AdminSchedulesList extends StatelessWidget {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          rows: page.results.map((schedule) {
            return DataRow(
              cells: [
                ...
                DataCell(AdminTransportStatusBadge(isActive: schedule.isActive)),
                DataCell(_Actions(
                  schedule: schedule,
                  canManage: canManage,
  ...
  Widget _buildCards() {
    return Column(
      children: page.results.map((schedule) {
        return Container(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  AdminTransportStatusBadge(isActive: schedule.isActive),
                ],
              ),
